...
export default function FooterContact() {
  return (
    ...
    >
      {/* Contenedor principal con responsividad mejorada */}
      <div className="flex flex-col md:flex-row gap-5 w-full">
        ...
        <div className="flex-1 bg-white rounded-3xl p-6 md:p-10 flex flex-col justify-center gap-4 shadow-lg">
          ...
          <form className="flex flex-col gap-3">
            {/* Inputs ahora se apilan en móviles */}
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                type="text"
                placeholder="Nombre"
                className="flex-1 p-2 rounded-full bg-gray-100 shadow-md focus:outline-none focus:ring-2 focus:ring-green-500"
              />
              <input
                type="email"
                placeholder="Correo"
            ...
            <textarea
              ...
              className="w-full p-2 rounded-2xl bg-gray-100 shadow-md focus:outline-none focus:ring-2 focus:ring-green-500"
              rows="4"
            ></textarea>
            <button
              type="submit"
